            ...
            (data) => {
                ...
                for (let i = 1; i <= this.statutPaiement.nombre_tranches_restantes; i++) {
                    const montantTranche = (i === 1)
                        ? this.statutPaiement.montant_a_payer / this.statutPaiement.nombre_tranches_autorisees
                        : (this.statutPaiement.montant_a_payer / this.statutPaiement.nombre_tranches_autorisees) * i
