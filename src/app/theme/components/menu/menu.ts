...
export const verticalMenuItems = [
    new Menu(1, 'Dashboard', '/', null, 'tachometer', null, false, 0, true),
...
//     new Menu(62, 'Classes', '/classe', null, 'folder', null, false, 60),
//     new Menu(63, 'Articles', '/article', null, 'file-o', null, false, 60),
